<?php
	class OrdersDAL
	{
		...
		public function addOrderItem(OrderItem $order_item) : ?int
		{
			try
			{
				$orderItemId = null;
				...
				$orderItemId = intval($this->ShopDb->conn->lastInsertId());
		...
		public function getOrderItemById(int $order_item_id) : ?OrderItem
		{
			try
			{
				$order_item = null;
